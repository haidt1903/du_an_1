...
if (exist_param("btn_list")) {
    ...
    //insert vào db
    hang_hoa_insert($ten_hh, $don_gia, $giam_gia, $hinh, $ma_loai, $dac_biet, $so_luot_xem, $ngay_nhap, $mo_ta,$so_luong_hang);
    ...
    hang_hoa_update($ma_hh, $ten_hh, $don_gia, $giam_gia, $hinh, $ma_loai, $dac_biet, $so_luot_xem, $ngay_nhap, $mo_ta,$so_luong_hang);
    //hiển thị danh sách
