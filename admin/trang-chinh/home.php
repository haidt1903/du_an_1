<div class="container">
<a href="http://locahost/du_an1/admin/loai-hang/index.php?btn_list">
    <div class="cards row mt-5">
        ...
        <a href="http://locahost/du_an1/admin/hang-hoa/index.php?btn_list">
        ...
        <a href="http://locahost/du_an1/admin/khach-hang/index.php?btn_list">
...
<a href="http://locahost/du_an1/admin/binh-luan/">
...
<br>
<a href="http://locahost/du_an1/admin/donhang/">
        <div class="card-single col d-flex justify-content-around bg-warning text-white py-5 ml-3 ">
            <div>
